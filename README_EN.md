...
There are now 10 sourced built-in corrections. This review classifies 7 of 14 remaining entries without genre metadata; 7 await further evidence. See the [review log](CLASSIFICATION_REVIEW.md) for sources, name-matching fixes and validation limits. This is not a whole-library accuracy measurement.
